...
export default class extends wepy.mixin {
        ...
        if (res.code) {
          ...
          wx.getUserInfo({
            success: function(userInfoRes) {
              ...
              wx.request({
                url: 'https://www.zhengzhicheng.cn/api/public/v1/users/wxlogin',
                method: 'post',
                data: {
                  code: res.code,
  ...
  methods = {
    ...
    async getUserInfo(userInfo) {
      ...
      console.log('获取用户登录的凭证=>', loginRes)
      ...
      console.log('发起登录的请求，换取登录成功之后的 Token 值=>', res)
      if (res.meta.status !== 200) {
        return wepy.baseToast('/users/wxlogin登录微信登录失败！')
      }
