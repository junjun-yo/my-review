<template>
    <div>
        <div style="margin:20px auto 10px 10px">
            <el-button type="primary" @click="deleteMail">彻底删除</el-button>
            <el-dropdown style="margin-left: 10px">
                ...
                <el-dropdown-menu slot="dropdown">
                    ...
                    <el-dropdown-item @click.native="">指定数据</el-dropdown-item>
                </el-dropdown-menu>
            </el-dropdown>
        </div>
        <div>
