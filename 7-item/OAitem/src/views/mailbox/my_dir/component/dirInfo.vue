        ...
        <div style="margin:20px auto 10px 10px">
            <el-dropdown style="margin-left: 10px">
                ...
                <el-dropdown-menu slot="dropdown">
                    <el-dropdown-item @click.native="">全部</el-dropdown-item>
                    <el-dropdown-item @click.native="">部分数据</el-dropdown-item>
                </el-dropdown-menu>
            </el-dropdown>
    ...
    export default {
        data(){
            return {
                //表格异步请求数据参数
                ajaxParams: {
                    url: "/mailbox/dirMailList",
                    method: "post",
                    params: {
                        creatorId:this.$store.state.account.sysUser.userId,
                        dirName:this.$route.query.dir.dirName,
                        mailId:this.$route.query.dir.mailId,
                        mailReceiverId:this.$route.query.dir.mailReciverId
                    }
                },
                //列头属性配置
                columns: [
