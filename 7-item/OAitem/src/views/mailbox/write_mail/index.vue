<template>
        <div style="margin-top:10px;margin-left: 20px"  >
            ...
            <div style="margin-top: 10px">
                <el-form :model="mailForm" label-position="right" :rules="rules" ref="mail">
                    ...
                    <el-form-item style="margin-left: 50px" prop="importance">
                        ...
                        <el-checkbox-group v-model="mailForm.receipt">
                            <el-checkbox label="1">回执</el-checkbox>
                        </el-checkbox-group>
                    </el-form-item>
                </el-form>
    ...
    export default {
        ...
        methods:{
            ...
            changeBCCType(){
             ...
             send(){
                ...
                this.$refs.mail.validate(valiad => {
                    if(valiad) {
                        this.mailForm.importance = this.mailForm.importance.length>0?this.mailForm.importance[0]+"":"0";
                        this.mailForm.receipt =this.mailForm.receipt.length>0?this.mailForm.receipt[0]+"":"0";
            ...
            saveToDraftBox(){
                ...
                this.$refs.mail.validate(valiad => {
                    if(valiad) {
                        this.mailForm.sendType = "0";
                        this.mailForm.mailLocation = "0";
                        this.mailForm.content= this.getUEContent();
                        Ajax.put("/mailbox/saveMailInfo",
                               this.mailForm
                        ).then(res =>{
